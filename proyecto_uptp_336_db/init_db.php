...
try {
    ...
    echo "<h2>--- INICIANDO INSTALACI�N DE LA BASE DE DATOS (PRODUCCI�N) ---</h2>";
    ...
    echo "<h3>?? �Sistema a limpio configurado! Base de datos vac�a lista para el inventario real.</h3>";
