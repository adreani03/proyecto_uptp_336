            ...
            <form action="<?= BASE_URL ?>/inventario/crear" method="POST">
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="serial_codigo" name="serial_codigo" placeholder="Aplica para equipos">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="stock_actual" name="stock_actual" value="0" min="0" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="stock_maximo" name="stock_maximo" value="0" min="0">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="hoja_seguridad" name="hoja_seguridad" placeholder="Ej: Enlace web o ubicación física">
                    </div>
                </div>
